...
const Register = () => {
  ...
  return (
    ...
    <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
        <h2 className='text-xl font-semibold mb-4'>Please Register Now</h2>
        ...
        <p className='mt-5 text-center text-gray-500 text-xs'>©2025 Prashant Store. All rights reserved.</p>
    </div>
</div>
  )
}
